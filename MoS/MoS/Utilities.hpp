...
void mat4tranFact(float M[]);
void mat4linFact(float M[]);
void mat4normalMatrix(float M[]);
void mat4rot(float M[],float vec[], float angle);
void mat4scale(float M[], float scale);
void mat4translate(float M[], float x, float y, float z);
void mat4perspective(float M[], float vfow, float aspect, float znear, float zfar);
void updateViewX(float angle, float V[]);
void updateViewY(float angle, float V[]);
void updateViewZ(float angle, float V[]);
